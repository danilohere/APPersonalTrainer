...
public class ExercicioActivity extends AppCompatActivity {
    ...
    private final int[] repEsq = new int[20];
    private final int[] repInd = new int[20];
    private int series;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTipoRep = findViewById(R.id.txtTipoRep);
    ...
    private void fimSerie(boolean aumentaSerie, boolean tocaSom) {
        Vibrar(300);
        if (tocaSom) {
            if (som == 0) {
                largada(1);
        ...
        if (aumentaSerie)
            serieAtual++;
        txtSeries.setText(String.valueOf(serieAtual));
        bancoDados.execSQL("UPDATE exercicios SET serieAtual = " + serieAtual + " WHERE idExercicio =" + id);
    }
    ...
    private void bambam(int num) {
        switch (num) {
            ...
            case 6:
                ...
                break;
            case 7:
                bambam = MediaPlayer.create(ExercicioActivity.this, R.raw.bambam7);
                break;
            case 8:
                bambam = MediaPlayer.create(ExercicioActivity.this, R.raw.bambam8);
                break;
            case 9:
                bambam = MediaPlayer.create(ExercicioActivity.this, R.raw.bambam9);
                break;
            case 10:
                bambam = MediaPlayer.create(ExercicioActivity.this, R.raw.bambam10);
                break;
            case 11:
                bambam = MediaPlayer.create(ExercicioActivity.this, R.raw.bambam11);
                break;
            case 12:
                bambam = MediaPlayer.create(ExercicioActivity.this, R.raw.bambam12);
                break;
            case 13:
                bambam = MediaPlayer.create(ExercicioActivity.this, R.raw.bambam13);
                break;
        }
        bambam.start();
    ...
    private void carregarValores(int proximo) {
        ...
        switch (tipoRep) {
            case 3:
                txtTipoRep.setText("Até a falha");
                txtRep.setText("1");
                txtBarra2.setText("");
                txtRepTotal.setText("");
                break;
            case 2:
                txtTipoRep.setText("Dropset");
                break;
            case 1:
                txtTipoRep.setText("Pirâmide");
                break;
            default:
                txtTipoRep.setText("");
                break;
