...
public class EditarExercicioActivity extends AppCompatActivity {
    ...
    private final String[] setExercicio = new String[20];
    private final int[] valorExercicios = new int[19];
    ...
    private final String[] unilateral = {
...
//                      //SÓ ALTERNADO
    ...
    private void escolherImagem(long m, long e) {
        int M = (int) m;
        int E = (int) e;
        switch (M) {
            case 0:
    ...
    private void adapter(String[] musculo) {
